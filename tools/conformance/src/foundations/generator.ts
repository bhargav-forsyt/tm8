...
export async function buildW1ConformanceManifest(): Promise<W1ConformanceManifest> {
  ...
  // 197 -> 198 (2026-09-07, skills integration U2): `skills.catalog`, one GET
  // read — the Space's skill entities unioned with the Claude Code and Codex
  // skill folders of its linked projects and the node user home. MEASURED.
  ...
  // 195 -> 196 (U2): skills.catalog is v1.
  ...
  // U2: GET 65->66 (skills.catalog).
  assertEqual(methods, { GET: 66, POST: 98, PATCH: 12, DELETE: 12, PUT: 8, WS: 2 }, 'method accounting');
  ...
  // 195 -> 196 (U2): skills.catalog mounts one GET route.
