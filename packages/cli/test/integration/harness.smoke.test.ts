...
it('starts a real Server and reports an un-enveloped /health', async () => {
  ...
  expect(h.operations).toBe(196) /* 195→196 U2: skills.catalog — one more ROUTE */ /* 171→195 177: the 24 container HTTP routes — ROUTES, not catalog rows */ /* 168→171 148: spaces.workflows.* — ROUTES, not catalog rows */; // +3 W4/132 — ROUTES, not catalog rows
