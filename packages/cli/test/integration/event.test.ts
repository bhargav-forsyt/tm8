...
describe('the node, measured rather than reported', () => {
  it('answers /health outside the envelope, with 155 mounted HTTP routes', async () => {
    ...
    expect(health.operations).toBe(196) /* 195→196 U2: skills.catalog — one more ROUTE */ /* 171→195 177: the 24 container HTTP routes — ROUTES, not catalog rows */ /* 168→171 148: spaces.workflows.* — ROUTES, not catalog rows */ /* 162→165 2026-08-16 W4/132: spaces.taskWorkflows.* */ /* 157→158 2026-08-13: #188 chat route */;
