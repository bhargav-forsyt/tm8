...
// 197 -> 198 (2026-09-07, skills integration U2): skills.catalog — the Space's
// skill entities unioned with the Claude Code and Codex skill folders of its
// linked projects and the node user home. v1, so 195 -> 196. MEASURED.
...
describe('the catalog itself is the shape W4 was briefed on', () => {
  it('198 rows = 196 v1 + 2 reserved, 196 mounted HTTP + 1 mounted WS (measured; +1 skills.catalog)', () => {
