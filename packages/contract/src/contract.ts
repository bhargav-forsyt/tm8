...
/**
 * PATCH /v2/spaces/:spaceId/members/:memberId — the space-role writer (118).
 *
 ...
 * and 118's `set_member_role` names both in one predicate so a cross-space id
 ...
 * holder is anybody on this node (118).
 *
