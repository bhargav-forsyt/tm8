...
describe('W2.G15 catalog and production-handler accounting', () => {
  ...
  it('keeps the exact 198 = 196 v1 + 2 reserved, 196 mounted HTTP + 1 mounted WS boundary (+25 177, +1 U2)', () => {
    ...
    // 197 -> 198 (U2): skills.catalog, one GET read. MEASURED.
    expect(OPERATIONS).toHaveLength(198); // +25 (177) containers +1 (U2), MEASURED
    ...
    )).toHaveLength(194); // 169 -> 193 (177): the container handlers; -> 194 (U2)
  });
